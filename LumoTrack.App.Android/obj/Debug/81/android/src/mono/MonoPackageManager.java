...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "LumoTrack.App.Android.dll" comes first in this list. */
		"LumoTrack.App.Android.dll",
		"Lottie.Android.dll",
		"LumoTrack.Common.dll",
		"LumoTrack.DTO.dll",
		"LumoTrack.Proxy.dll",
		"LumoTrack.ProxyContract.dll",
		...
		"Zorbek.Core.Security.Client.dll",
		"Zorbek.Core.Security.Commons.dll",
		"Zorbek.Essentials.Clients.dll",
		"Zorbek.Essentials.Std.Utilities.dll",
	};
